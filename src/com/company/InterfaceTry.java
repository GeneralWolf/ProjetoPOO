...
public class InterfaceTry extends JFrame {
    ...
    public InterfaceTry(CentroInvestigacao ci) {
        //Detalhes do painel
    ...
    public void InterfaceCriarProjTry(CentroInvestigacao ci) {
        ...
        buttonCriar.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                try{
                    ...
                    System.out.println(nomesProjetos);   //isto prova que nomesProjetos recebe o nome
                    //listScroller.updateUI();  //didnt do jack shit
